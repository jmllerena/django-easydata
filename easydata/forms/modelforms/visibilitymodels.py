...
configuracion de visibilidad de los modelos.
"""
...
class VisibilityModelsForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(VisibilityModelsForm, self).__init__(*args, **kwargs)
